(function() {
  var translations = {
    ...
    'added_1_feature': 'Added 1 feature to \'{{layer}}\' via {{ application_name }} Composer.',
    'modified_1_feature': 'Modified 1 feature in \'{{layer}}\' via {{ application_name }} Composer.',
    'modified_x_features': 'Modified {{num}} features in \'{{layer}}\' via {{ application_name }} Composer.',
    'removed_1_feature': 'Removed 1 feature from \'{{layer}}\' via {{ application_name }} Composer.',
    'applied_via_maploom': 'Applied via {{ application_name }} Composer.',
