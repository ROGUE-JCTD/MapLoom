(function() {
  var translations = {
    ...
    'added_1_feature': 'Añadió 1 elemento a \'{{layer}}\' a través {{ application_name }} Composer.',
    'modified_1_feature': 'Modificado 1 elemento de \'{{layer}}\' a través {{ application_name }} Composer.',
    'modified_x_features': 'Modificado {{num}} elementos de \'{{layer}}\' a través {{ application_name }} Composer.',
    'removed_1_feature': 'Eliminado 1 elemento de \'{{layer}}\' a través {{ application_name }} Composer.',
    'applied_via_maploom': 'Aplica a través de {{ application_name }} Composer.',
